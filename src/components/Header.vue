<template>
  <div class="header">
    <a class="header_home" href="/">
      <img class="header_logo" src='../assets/logo.png'/>
      Imf & Firus
    </a>
    <img class="header_burger" src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Hamburger_icon.svg/1200px-Hamburger_icon.svg.png" />
